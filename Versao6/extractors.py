...
ARCHIVE_PASSWORDS = {"arquivo1.zip": "senha123", "arquivo2.rar": "outrasenha"}
...
def get_archive_password(archive_name):
    """Retorna a senha do arquivo compactado se existir no .env"""
    passwords = json.loads(os.getenv('ARCHIVE_PASSWORDS', '{}'))
    return passwords.get(archive_name)
