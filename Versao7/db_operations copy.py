...
def clean_string(value):
    """
    Remove caracteres nulos de strings.
    """
...
def sanitize_data(data):
    """
    Sanitiza todos os valores de uma tupla, removendo caracteres inválidos.
    """
    return tuple(clean_string(value) if isinstance(value, str) else value for value in data)
...
def insert_data_into_main_table(data):
    """
    Insere os dados na tabela principal, sanitizando strings para evitar NULs.
    """
    conn = get_db_connection()
    cur = conn.cursor()
